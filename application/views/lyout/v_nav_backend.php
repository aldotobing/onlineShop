         ...
         <nav class="mt-2">
             <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                 ...
                 <li class="nav-item">
                     <a href="<?= base_url('goods') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'goods') {
                                                                            echo "active";
                                                                        } ?>">
                 ...
                 <li class="nav-item">
                     <a href="<?= base_url('picturegoods') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'picturegoods') {
                                                                                    echo "active";
                                                                                } ?>">
                 ...
                 <li class="nav-item">
                     <a href="<?= base_url('admin/order_income') ?>" class="nav-link <?php if ($this->uri->segment(2) == 'order_income' and $this->uri->segment(1) == 'admin') {
                                                                                            echo "active";
                                                                                        } ?>">
